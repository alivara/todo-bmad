...
description: Memory philosophy and practices for Gopher
---
...
- Preferences observed — how this owner weighs correctness vs. speed vs. readability, review feedback that lands
- Patterns across sessions — recurring bugs, returning design questions, the shape of their codebase
- This codebase's idioms — error wrapping style, package layout, naming, test conventions
